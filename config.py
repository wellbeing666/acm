...
GENERATED_RUNS_DIR = GENERATED_CASES_DIR / "runs"
...
RABBITMQ_ENABLED = os.getenv("RABBITMQ_ENABLED", "true").lower() in {"1", "true", "yes", "on"}
RABBITMQ_REQUIRED = os.getenv("RABBITMQ_REQUIRED", "false").lower() in {"1", "true", "yes", "on"}
RABBITMQ_HOST = os.getenv("RABBITMQ_HOST", "localhost")
RABBITMQ_PORT = int(os.getenv("RABBITMQ_PORT", "5672"))
RABBITMQ_USER = os.getenv("RABBITMQ_USER", "agent")
RABBITMQ_PASSWORD = os.getenv("RABBITMQ_PASSWORD", "password123")
RABBITMQ_EXCHANGE = os.getenv("RABBITMQ_EXCHANGE", "agent.events")
